...
struct ScrapBookDrag: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            TopBackButton.frame(maxWidth: .infinity, maxHeight: .infinity,alignment: .topLeading).padding(.top, 40).ignoresSafeArea()//.padding([.top, .leading], 20)
            ...
            HStack(spacing: 15) {
                ...
                Button {
                    ...
                    Image("back_button")
                        .resizable()
                        .scaledToFit()
                        .frame(width: 40, height: 40).padding(.leading, -7)
                ...
                Button {
                    ...
                    Image("forward_button")
                        .resizable()
                        .scaledToFit()
                        .frame(width: 40, height: 40).padding(.trailing, -7)
